...
public:
    ...
    // which makes the code more readable, maintainable, and
    // less error-prone compared to using raw integer values.
    enum class FACE {
        UP,
        LEFT,
        FRONT,
    ...
    // By default, these constants are assigned integral values
    // starting from 0, so Red is 0, Green is 1, and Blue is 2.
    enum class COLOR {
        WHITE,
        GREEN,
        RED,
